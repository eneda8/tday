...
const {isLoggedIn, isAuthor, validatePost, hasPostedToday} = require("../middleware");
...
router.route("/")
    ...
    .post(isLoggedIn, upload.single("image"), validatePost, hasPostedToday, catchAsync(posts.createPost));

router.get("/new", isLoggedIn, hasPostedToday, posts.renderNewForm);
